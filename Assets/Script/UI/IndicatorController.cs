...
namespace LearningAIGame.CombatSystem
{
    ...
    /// </summary>
    public class IndicatorController : MonoBehaviour, IGameHelper
    {
        #region === インスペクター設定 ===
        ...
        [SerializeField]
        private DirectionIndicatorUI _playerIndicator;

        [SerializeField]
        private DirectionIndicatorUI _npcIndicator;
        ...
        public void SetUp()
        {
            ...
            _playerIndicator.Initialize(GameManager.Instance.PlayerInstance);
            _npcIndicator.Initialize(GameManager.Instance.CurrentNpcInstance);
        }
